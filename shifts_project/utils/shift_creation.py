...
def main():
	start_datetime = make_aware(datetime.datetime(2018,6,24,8,0), get_default_timezone())
	end_datetime = make_aware(datetime.datetime(2018,6,24,9,0), get_default_timezone())
